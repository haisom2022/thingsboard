...
public interface UserService extends EntityDaoService {
    ...
    PageData<User> findEndUsersByTenantId(TenantId tenantId, PageLink pageLink);

    PageData<User> findEndUsersByCustomerId(CustomerId customerId, PageLink pageLink);
