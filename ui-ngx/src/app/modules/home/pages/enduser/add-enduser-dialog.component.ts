...
@Component({
  ...
  templateUrl: './add-enduser-dialog.component.html',
  styleUrls: ['./add-enduser-dialog.component.scss']
})
export class AddEnduserDialogComponent extends DialogComponent<AddEnduserDialogComponent, User> implements OnInit {
  ...
  @ViewChild(EnduserComponent, {static: true}) userComponent: EnduserComponent;

  constructor(protected store: Store<AppState>,
              protected router: Router,
              @Inject(MAT_DIALOG_DATA) public data: AddUserDialogData,
              public dialogRef: MatDialogRef<AddEnduserDialogComponent, User>,
  ...
  add(): void {
    if (this.detailsForm.valid) {
      ...
      this.user.authority = Authority.END_USER;
      ...
      this.userService.saveEnduser(this.user, sendActivationEmail).subscribe(
        (user) => {
